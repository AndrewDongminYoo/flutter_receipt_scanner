...
/**
 * Launched by FlutterReceiptScannerPlugin for the gallery+crop flow.
...
internal class CropEditorActivity : ComponentActivity() {
    companion object {
         ...
         * `ImageProcessor.MAX_PROCESSING_DIM` because the editor only needs a display-
    ...
    private fun loadNextImage() {
        ...
        confirmBtn.text =
            if (pendingUris.isNotEmpty()) {
                ...
                getString(R.string.receiptScanner_confirmButton)
            }
    ...
    private fun buildCropUI() {
        ...
        val instructionView =
            TextView(this).apply {
                text = context.getString(R.string.receiptScanner_cropInstruction)
        ...
        val cancelBtn =
            Button(this).apply {
                id = cancelId
                text = context.getString(R.string.receiptScanner_cancelButton)
        ...
        confirmBtn =
            Button(this).apply {
                id = confirmId
                text = context.getString(R.string.receiptScanner_confirmButton)
                setTextColor(0xFF007AFF.toInt())
                textSize = 17f
                setTypeface(typeface, Typeface.BOLD)
                background = null
    ...
    // an error extra so FlutterReceiptScannerPlugin can reject with a processing code —
