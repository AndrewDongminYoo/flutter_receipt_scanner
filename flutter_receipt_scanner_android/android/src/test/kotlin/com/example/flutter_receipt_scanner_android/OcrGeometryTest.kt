...
import com.example.flutter_receipt_scanner_android.OcrGeometry.Box
import org.junit.Assert.assertEquals
import org.junit.Assert.assertNull
import org.junit.Test

/**
 * Pins the OcrGeometry sign/tie conventions that the Swift `OcrGeometry` mirrors
 * by hand — a swapped axis or a 90/270 mix-up here silently ships wrong boxes.
 * Ported from the RN `OcrGeometryTest`.
 */
class OcrGeometryTest {
    ...
    fun `quantize breaks ties toward positive infinity`() {
        ...
        // the Swift OcrGeometry mirrors this, where the obvious lround() rounds
    ...
    @Test
    fun `correction separates the two lie directions`() {
        // The whole point of the redesign (native port map §6): a receipt laid
        // down clockwise vs counter-clockwise needs opposite corrections, which a
        // fixed default cannot give.
