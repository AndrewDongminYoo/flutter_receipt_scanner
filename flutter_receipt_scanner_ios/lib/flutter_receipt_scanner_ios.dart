...
class FlutterReceiptScannerIos extends FlutterReceiptScannerPlatform {
  /// Creates the iOS platform, optionally with an injected [api] for tests.
  FlutterReceiptScannerIos({@visibleForTesting ReceiptScannerApi? api}) : _api = api ?? ReceiptScannerApi();

  final ReceiptScannerApi _api;

  /// Registers this class as the default platform instance.
  static void registerWith() {
    FlutterReceiptScannerPlatform.instance = FlutterReceiptScannerIos();
  }
